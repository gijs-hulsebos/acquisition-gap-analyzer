...
export const DEMO_COMPETITOR_RESULT: AnalysisResult = {
  ...
  readiness: {
    ...
    categories: [
      ...
      },
      {
        ...
        weight: 30,
        confidence: "High",
        explanation: "Featured products expose a direct Add to cart action on the landing page.",
        evidence: [{ statement: "A direct ‘Tilføj til kurv’ / Add to cart control is available beside featured products.", pageLabel: "Søstrene Grene landing-page CTA", url: SOSTRENE_URL }],
        recommendation: "Keep the direct product CTA visible and specific.",
      },
      {
        id: "customer-journey-path",
        label: "Customer Journey Path",
  ...
  pages: [
    ...
    { title: "Featured product", url: `${SOSTRENE_URL}/product`, type: "Product", statusCode: 200 },
  ...
  gaps: [
    ...
    },
    {
      ...
      rank: 2,
      title: "CTA Clarity",
      summary: "Featured products expose a direct Add to cart action on the landing page.",
      severity: "Low",
      score: 100,
      confidence: "High",
      evidence: [{ statement: "A direct ‘Tilføj til kurv’ / Add to cart control is available beside featured products.", pageLabel: "Søstrene Grene landing-page CTA", url: SOSTRENE_URL }],
      nextAction: "Keep the direct product CTA visible and specific.",
    },
    {
      id: "customer-journey-path",
      rank: 3,
