...
const DILLE_CHECKLISTS: Record<GapId, FindingCriterion[]> = {
  ...
  "customer-journey-path": [
    ...
    { label: "Add-to-cart accessibility (20%)", status: "partial", detail: "Add to cart is available on the product page, worth 10 of 20 points." },
...
const SOSTRENE_CHECKLISTS: Record<GapId, FindingCriterion[]> = {
  ...
  "customer-journey-path": [
    ...
    { label: "Add-to-cart accessibility (20%)", status: "met", detail: "Add to cart is available directly on the landing page." },
...
export const DEMO_RESULT: AnalysisResult = {
  ...
  summary: "Representative journey score: 77/100 across the three fixed findings.",
  overview: {
    score: 77,
    status: "Mixed",
